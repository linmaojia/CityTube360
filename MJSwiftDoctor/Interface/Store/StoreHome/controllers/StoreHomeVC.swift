...
class StoreHomeVC: MJBasicViewController {
    var dataArray = ["StoreHomeVC","StoreHomeVC","StoreHomeVC"]
...
extension StoreHomeVC: UITableViewDelegate, UITableViewDataSource {
